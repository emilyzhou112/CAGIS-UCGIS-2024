...
AHP_TOPSIS, TOPSIS, WSM, PROMETHEE
...
rank_compare <- WSM %>% 
  ...
  mutate(avg_rank = (wsm_rank + topsis_rank + promethee_rank + ahptopsis_rank) / 4)
...
pal <- colorBin(palette = "viridis", # change the color palette here
                ...
                bins = c(200, 400, 600, 800, 1000, 1200)) # change the bins here 
