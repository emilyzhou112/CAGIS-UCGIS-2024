...
quantiles <- classIntervals(WSM$score, n = 6, style = "quantile")
...
quantiles <- classIntervals(AHP_TOPSIS_toplot$values, n = 6, style = "quantile")
...
```{r compare difference distribution}
...
compare %>% 
  ...
  pivot_longer(cols = c("wsm_topsis", "wsm_promethee", "promethee_topsis", "compare_weights"),  
               ...
               values_to = "value") %>% 
  ggplot(aes(x = value)) +
  geom_histogram(binwidth = 10, color="#726DA8", alpha = 0.7) +
